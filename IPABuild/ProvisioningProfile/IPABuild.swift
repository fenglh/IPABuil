...
class IPABuild {
    ...
    public func build(scheme name: String,
               configurationType: ConfigurationType = .Release,
        ...
        guard let bundleId = target.bundleId(withConfigurationType: configurationType) else {
        ...
        let certificateName = certificate.subjectCommonNames?.first else {
        ...
        args.append("-configuration \(configurationType.rawValue)")
